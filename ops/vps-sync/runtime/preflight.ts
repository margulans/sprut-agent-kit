...
const PLUGINS = [
  // // // "https://github.com/SawyerHood/dev-browser", // disabled: firewall blocks github // disabled: firewall blocks github // disabled: firewall blocks github
  // // // "https://github.com/thedotmack/claude-mem", // disabled: already installed, firewall blocks github // disabled: already installed, firewall blocks github // disabled: already installed, firewall blocks github
  // // // "https://github.com/obra/superpowers-marketplace", // disabled: not needed // disabled: not needed // disabled: not needed
  // Add more repos here:
...
const OFFICIAL_PLUGINS = [
  "ralph-loop",
  "hookify",
  // // // "code-review", // disabled // disabled // disabled
  // // // "pr-review-toolkit", // disabled // disabled // disabled
  // // // "commit-commands", // disabled // disabled // disabled
  // // // "plugin-dev", // disabled // disabled // disabled
